    ...
    const postOrder = async () => {
      try {
        ...
        if (response.success) {
          ...
          const apiError =
            response.error ||
            "Cannot confirm order, some items are unavailable";
    ...
    return (
      <div className="text-center py-5">
        ...
        <p className="mt-3 text-muted">
          Confirming if order can be processed...
        </p>
      </div>
    );
  }
      ...
      <div className="container py-4">
        <div className="row justify-content-center">
          <div className="col-12 col-lg-8 col-xl-7">
            <div
              className="alert alert-success shadow-sm d-flex align-items-center mb-4"
              role="alert"
            >
              <svg
                ...
                height="32"
                fill="currentColor"
                className="bi bi-check-circle-fill me-3 flex-shrink-0"
                viewBox="0 0 16 16"
              >
              ...
              <div>
                ...
                <p className="mb-0">
                  ...
                  {confirmationToken && (
                    <>
                      <strong>Payment Confirmation Token:</strong>{" "}
                      {confirmationToken}
                      <br />
                    </>
                  )}
